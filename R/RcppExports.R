...
ale_sweep_cpp <- function(ord_idx, d_l_mat, interval_idx_mat, offsets,
  tot_n, tot_s1, tot_s2, r_risks, is_cand, min_node_size,
  split_feat_j, use_stabilizer, z_sorted, n_obs) {
  .Call(`_gadget_ale_sweep_cpp`, ord_idx, d_l_mat,
    interval_idx_mat, offsets, tot_n, tot_s1, tot_s2,
    r_risks, is_cand, min_node_size, split_feat_j,
    use_stabilizer, z_sorted, n_obs)
}
...
search_best_split_point_cpp <- function(z, Y, n_quantiles = NULL,
  is_categorical = FALSE, min_node_size = 1L) {
  .Call(`_gadget_search_best_split_point_cpp`, z, Y,
