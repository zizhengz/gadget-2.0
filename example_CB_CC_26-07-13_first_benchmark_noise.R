...
# Selective early stopping methods (Section 5.1). Method 4
# ("interaction_fraction_total") is not implemented yet.
methods = c("plain_risk", "risk_reduction", "interaction_fraction")
