...
run_split_test = function(n, times = 50) {
  ...
  bench.single = microbenchmark(
    R   = search_best_split(Z.single, Y.single, min.node.size = 1, n.quantiles = NULL),
    Cpp = search_best_split_cpp(Z.single, Y.single, min_node_size = 1, n_quantiles = NULL),
    times = times
  )
  ...
  bench.multi = microbenchmark(
    R   = search_best_split(Z.multi, Y.multi, min.node.size = 1, n.quantiles = NULL),
    Cpp = search_best_split_cpp(Z.multi, Y.multi, min_node_size = 1, n_quantiles = NULL),
    times = times
  )
